...
\[
\text{Violation}_{\text{parallel}}(t) = \mathbb{1}\left(|p_{i,t} - p_{j,t}| \equiv \Delta\right) \times \mathbb{1}\left(|p_{i,t-1} - p_{j,t-1}| \equiv \Delta\right) \times \mathbb{1}\left(\text{sgn}(\Delta p_i) = \text{sgn}(\Delta p_j)\right) \times \mathbb{1}\left(\Delta p_i \neq 0\right)
\]
...
\[
\text{Violation}_{\text{leading}}(t) = \mathbb{1}\left(p_{i,t} \equiv L_{\text{pc}}\right) \times \mathbb{1}\left(p_{i,t+1} \not\equiv K_{\text{tonic}}\right)
\]
